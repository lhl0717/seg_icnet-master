...
antenna_param = {'name': 'antenna',
                    'input_size': [1024, 2048],
                    'num_classes': 2,
                    'ignore_label': 255,
                    'num_steps': 800,
                    'data_dir': 'D:/demo/data0',
                    'data_list': './list/antenna_train1.txt'}
...
def get_arguments():
    ...
    parser.add_argument("--dataset", type=str, default='antenna',
...
def main():
    ...
    if args.model == 'others':
        ...
        if ckpt and ckpt.model_checkpoint_path:
            ...
            load(loader, sess, './model/model.ckpt-60000')
        else:
...
if __name__ == '__main__':
    main()
    '''
     python evaluate.py --dataset=antenna --filter-scale=1 --model=others 
    '''
